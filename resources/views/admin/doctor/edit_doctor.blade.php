                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="POST" action="{{route('doctor.update', $doctor->doc_id)}}" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="doc_name" placeholder="Enter Name" type="text" value="{{ $doctor->doc_name }}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" id="number" name="doc_phone" placeholder="Enter Your Number" class="form-control col-md-7 col-xs-12" value="{{ $doctor->doc_phone }}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" id="address" name="doc_address" placeholder="Enter Address" class="form-control col-md-7 col-xs-12" value="{{ $doctor->doc_address }}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" id="schedule" name="doc_schedule" class="form-control col-md-7 col-xs-12" value="{{ $doctor->doc_schedule }}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input id="profile" type="text" name="doc_profile" class="form-control col-md-7 col-xs-12" value="{{ $doctor->doc_profile }}">
