            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="POST" action="{{route('bed.store')}}">
                            @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" id="bed_capacity" name="bed_capacity" class="form-control" placeholder="Enter Details" value="{{ old('bed_capacity') }}">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" id="bed_charge" name="bed_charge" class="form-control" placeholder="Enter Details" value="{{ old('bed_charge') }}">
